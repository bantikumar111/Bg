  ...
  const BgSlider = () => {
    ...
    return (
      ...
      {/* slider */}
          <input className='slider absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2' type="range" min={0} max={100} value={sliderPosition} onChange={handleSliderChange} />
        </div>
      </div>
    )
  }
